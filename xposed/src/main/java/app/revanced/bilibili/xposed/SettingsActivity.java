...
/** Standalone first-round settings; unported controls are explicitly storage-only. */
public final class SettingsActivity extends Activity {
    ...
    @Override protected void onCreate(Bundle state) {
        ...
        try (var stream = getAssets().open("settings-schema.json")) {
            ...
            android.util.Log.e(ModuleConstants.TAG, "Settings schema unavailable", error);
            schema = new JSONArray();
            toast("设置目录读取失败，请重新安装完整模块。");
        }
    }
    ...
    private TextView text(String value, int size) {
        ...
        view.setTextColor(Color.rgb(45, 45, 50));
    ...
    private void render() {
        ...
        text("LSPosed 首轮移植 · 粉版 8.27.0", 15);
        ...
        var catalog = getSharedPreferences(CatalogProvider.LOCAL_GROUP, MODE_PRIVATE);
        ...
        button("刷新状态", this::render, true);
        button("打开哔哩哔哩", () -> {
            Intent launch = getPackageManager().getLaunchIntentForPackage(ModuleConstants.HOST);
        ...
        try {
            ...
            if (tabs.length() == 0) {
                ...
                for (int i = 0; i < tabs.length(); i++) {
                    ...
                    choice.setEnabled(preferences != null);
            ...
            button("恢复显示全部底栏", () -> save(editor -> editor.remove(ModuleConstants.BOTTOM_KEY)), preferences != null);
    ...
    private void renderSettings() {
        ...
        for (int i = 0; i < schema.length(); i++) {
            ...
            row.setEnabled(module.preferences() != null);
    ...
    private void edit(JSONObject definition) {
        try {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(this).setTitle(definition.getString("title"))
            ...
            if ("Boolean".equals(type)) {
                ...
                builder.setView(toggle).setPositiveButton("保存", (dialog, which) -> {
